<template>
  <a-modal v-model="show" title="添加检查机构" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="8">
          <a-form-item label='功能检查机构名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="8">
          <a-form-item label='二级检查机构单位性质' v-bind="formItemLayout">
            <a-input v-decorator="[
            'natureTwo'
            ]"/>
          </a-form-item>
        ...
        <a-col :span="8">
          <a-form-item label='英文检查机构名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'enName'
            ]"/>
          </a-form-item>
        ...
        <a-col :span="24">
          <a-form-item label='检查机构照片' v-bind="formItemLayout">
            <a-upload
              name="avatar"
