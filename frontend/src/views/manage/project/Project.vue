          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.projectType"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
...
import moduleAdd from './ProjectAdd.vue'
import moduleEdit from './ProjectEdit.vue'
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '发布中':
              return <a-tag color="green">发布中</a-tag>
            case '已截止':
              return <a-tag color="blue">已截止</a-tag>
            case '已暂停':
              return <a-tag color="red">已暂停</a-tag>
            default:
              return '- -'
          }
        }
