<template>
  <a-modal v-model="show" title="修改参保情况" @cancel="onClose" :width="600">
...
export default {
  ...
  methods: {
    ...
    setFormValues ({...dishes}) {
      ...
      let fields = ['enrollmentStatus', 'totalMedicalExpenses', 'actualAmount' ]
      let obj = {}
      Object.keys(dishes).forEach((key) => {
        if (key === 'proofFilePath') {
          this.fileList = []
          this.imagesInit(dishes['proofFilePath'])
        }
