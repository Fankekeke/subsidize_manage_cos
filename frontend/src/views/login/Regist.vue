<template>
  <a-card :bordered="false" hoverable style="margin-top:  10px;background-color: #f9f9f9">
    <div style="text-align: left;font-size: 14px;margin-bottom: 30px"><b>大学生资助系统</b></div>
    <div class="user-layout-register">
      <a-form ref="formRegister" :autoFormCreate="(form)=>{this.form = form}" id="formRegister">
        <a-form-item>
          <a-input type="text" v-model="name" placeholder="身份证号码"></a-input>
        </a-form-item>
        <a-button
          type="primary"
  ...
  methods: {
    ...
    faceViewOpen () {
      if (this.name !== '') {
        ...
        this.$message.warning('请先输入身份证号码')
      }
    },
    isMobile () {
